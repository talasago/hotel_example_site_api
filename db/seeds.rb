...
Plan.create!(id: 2, name: 'ディナー付きプラン', room_bill: 8500, min_head_count: 1, max_head_count: 4, min_term: 1, max_term: 3, room_type_id: nil, only: 'normal')
Plan.create!(id: 3, name: 'お得なプラン', room_bill: 6000, min_head_count: 1, max_head_count: 9, min_term: 1, max_term: 9, room_type_id: nil, only: 'normal')
...
Plan.create!(id: 6, name: 'エステ・マッサージプラン', room_bill: 9000, min_head_count: 1, max_head_count: 6, min_term: 1, max_term: 9, room_type_id: nil, only: nil)
